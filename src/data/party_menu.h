...
static const struct PartyMenuBoxInfoRects sPartyBoxInfoRects[] =
{
    ...
    [PARTY_BOX_EQUAL_COLUMN] =
    {
        ...
        {
            // x, y, width, height of each bit of info
            33, 2, 40, 13,  // Nickname
            3, 25, 32, 8,   // Level
            100, 1, 8, 8,   // Gender
            70, 23, 24, 8,  // HP
...
static const u8 sPartyMenuSpriteCoords[PARTY_LAYOUT_COUNT][PARTY_SIZE][4 * 2] =
{
    [PARTY_LAYOUT_SINGLE] = 
    {
        { 24,  14,  24,  22, 104,  31,  24,  18},
        {136,  22, 136,  30, 216,  39, 136,  26},
        { 24,  54,  24,  62, 104,  71,  24,  58},
        {136,  62, 136,  70, 216,  79, 136,  66},
        { 24,  94,  24,  102, 104,  111,  24,  98},
        {136, 102, 136, 110, 216, 119, 136, 106},
    },
    [PARTY_LAYOUT_DOUBLE] = 
    {
