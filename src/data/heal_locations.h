static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 3, 7},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 14, 7},
    ...
    [HEAL_LOCATION_TWINLEAF_TOWN - 1] = {MAP_GROUP(TWINLEAF_TOWN), MAP_NUM(TWINLEAF_TOWN), 14, 23},
};
