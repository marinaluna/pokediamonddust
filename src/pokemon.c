...
#define SPECIES_TO_SINNOH(name)      [SPECIES_##name - 1] = SINNOH_DEX_##name
...
{
    SPECIES_TO_SINNOH(BULBASAUR),
    SPECIES_TO_SINNOH(IVYSAUR),
    SPECIES_TO_SINNOH(VENUSAUR),
    SPECIES_TO_SINNOH(CHARMANDER),
    SPECIES_TO_SINNOH(CHARMELEON),
    SPECIES_TO_SINNOH(CHARIZARD),
    SPECIES_TO_SINNOH(SQUIRTLE),
    SPECIES_TO_SINNOH(WARTORTLE),
    SPECIES_TO_SINNOH(BLASTOISE),
    SPECIES_TO_SINNOH(CATERPIE),
    SPECIES_TO_SINNOH(METAPOD),
    SPECIES_TO_SINNOH(BUTTERFREE),
    SPECIES_TO_SINNOH(WEEDLE),
    SPECIES_TO_SINNOH(KAKUNA),
    SPECIES_TO_SINNOH(BEEDRILL),
    SPECIES_TO_SINNOH(PIDGEY),
    SPECIES_TO_SINNOH(PIDGEOTTO),
    SPECIES_TO_SINNOH(PIDGEOT),
    SPECIES_TO_SINNOH(RATTATA),
    SPECIES_TO_SINNOH(RATICATE),
    SPECIES_TO_SINNOH(SPEAROW),
    SPECIES_TO_SINNOH(FEAROW),
    SPECIES_TO_SINNOH(EKANS),
    SPECIES_TO_SINNOH(ARBOK),
    SPECIES_TO_SINNOH(PIKACHU),
    SPECIES_TO_SINNOH(RAICHU),
    SPECIES_TO_SINNOH(SANDSHREW),
    SPECIES_TO_SINNOH(SANDSLASH),
    SPECIES_TO_SINNOH(NIDORAN_F),
    SPECIES_TO_SINNOH(NIDORINA),
    SPECIES_TO_SINNOH(NIDOQUEEN),
    SPECIES_TO_SINNOH(NIDORAN_M),
    SPECIES_TO_SINNOH(NIDORINO),
    SPECIES_TO_SINNOH(NIDOKING),
    SPECIES_TO_SINNOH(CLEFAIRY),
    SPECIES_TO_SINNOH(CLEFABLE),
    SPECIES_TO_SINNOH(VULPIX),
    SPECIES_TO_SINNOH(NINETALES),
    SPECIES_TO_SINNOH(JIGGLYPUFF),
    SPECIES_TO_SINNOH(WIGGLYTUFF),
    SPECIES_TO_SINNOH(ZUBAT),
    SPECIES_TO_SINNOH(GOLBAT),
    SPECIES_TO_SINNOH(ODDISH),
    SPECIES_TO_SINNOH(GLOOM),
    SPECIES_TO_SINNOH(VILEPLUME),
    SPECIES_TO_SINNOH(PARAS),
    SPECIES_TO_SINNOH(PARASECT),
    SPECIES_TO_SINNOH(VENONAT),
    SPECIES_TO_SINNOH(VENOMOTH),
    SPECIES_TO_SINNOH(DIGLETT),
    SPECIES_TO_SINNOH(DUGTRIO),
    SPECIES_TO_SINNOH(MEOWTH),
    SPECIES_TO_SINNOH(PERSIAN),
    SPECIES_TO_SINNOH(PSYDUCK),
    SPECIES_TO_SINNOH(GOLDUCK),
    SPECIES_TO_SINNOH(MANKEY),
    SPECIES_TO_SINNOH(PRIMEAPE),
    SPECIES_TO_SINNOH(GROWLITHE),
    SPECIES_TO_SINNOH(ARCANINE),
    SPECIES_TO_SINNOH(POLIWAG),
    SPECIES_TO_SINNOH(POLIWHIRL),
    SPECIES_TO_SINNOH(POLIWRATH),
    SPECIES_TO_SINNOH(ABRA),
    SPECIES_TO_SINNOH(KADABRA),
    SPECIES_TO_SINNOH(ALAKAZAM),
    SPECIES_TO_SINNOH(MACHOP),
    SPECIES_TO_SINNOH(MACHOKE),
    SPECIES_TO_SINNOH(MACHAMP),
    SPECIES_TO_SINNOH(BELLSPROUT),
    SPECIES_TO_SINNOH(WEEPINBELL),
    SPECIES_TO_SINNOH(VICTREEBEL),
    SPECIES_TO_SINNOH(TENTACOOL),
    SPECIES_TO_SINNOH(TENTACRUEL),
    SPECIES_TO_SINNOH(GEODUDE),
    SPECIES_TO_SINNOH(GRAVELER),
    SPECIES_TO_SINNOH(GOLEM),
    SPECIES_TO_SINNOH(PONYTA),
    SPECIES_TO_SINNOH(RAPIDASH),
    SPECIES_TO_SINNOH(SLOWPOKE),
    SPECIES_TO_SINNOH(SLOWBRO),
    SPECIES_TO_SINNOH(MAGNEMITE),
    SPECIES_TO_SINNOH(MAGNETON),
    SPECIES_TO_SINNOH(FARFETCHD),
    SPECIES_TO_SINNOH(DODUO),
    SPECIES_TO_SINNOH(DODRIO),
    SPECIES_TO_SINNOH(SEEL),
    SPECIES_TO_SINNOH(DEWGONG),
    SPECIES_TO_SINNOH(GRIMER),
    SPECIES_TO_SINNOH(MUK),
    SPECIES_TO_SINNOH(SHELLDER),
    SPECIES_TO_SINNOH(CLOYSTER),
    SPECIES_TO_SINNOH(GASTLY),
    SPECIES_TO_SINNOH(HAUNTER),
    SPECIES_TO_SINNOH(GENGAR),
    SPECIES_TO_SINNOH(ONIX),
    SPECIES_TO_SINNOH(DROWZEE),
    SPECIES_TO_SINNOH(HYPNO),
    SPECIES_TO_SINNOH(KRABBY),
    SPECIES_TO_SINNOH(KINGLER),
    SPECIES_TO_SINNOH(VOLTORB),
    SPECIES_TO_SINNOH(ELECTRODE),
    SPECIES_TO_SINNOH(EXEGGCUTE),
    SPECIES_TO_SINNOH(EXEGGUTOR),
    SPECIES_TO_SINNOH(CUBONE),
    SPECIES_TO_SINNOH(MAROWAK),
    SPECIES_TO_SINNOH(HITMONLEE),
    SPECIES_TO_SINNOH(HITMONCHAN),
    SPECIES_TO_SINNOH(LICKITUNG),
    SPECIES_TO_SINNOH(KOFFING),
    SPECIES_TO_SINNOH(WEEZING),
    SPECIES_TO_SINNOH(RHYHORN),
    SPECIES_TO_SINNOH(RHYDON),
    SPECIES_TO_SINNOH(CHANSEY),
    SPECIES_TO_SINNOH(TANGELA),
    SPECIES_TO_SINNOH(KANGASKHAN),
    SPECIES_TO_SINNOH(HORSEA),
    SPECIES_TO_SINNOH(SEADRA),
    SPECIES_TO_SINNOH(GOLDEEN),
    SPECIES_TO_SINNOH(SEAKING),
    SPECIES_TO_SINNOH(STARYU),
    SPECIES_TO_SINNOH(STARMIE),
    SPECIES_TO_SINNOH(MR_MIME),
    SPECIES_TO_SINNOH(SCYTHER),
    SPECIES_TO_SINNOH(JYNX),
    SPECIES_TO_SINNOH(ELECTABUZZ),
    SPECIES_TO_SINNOH(MAGMAR),
    SPECIES_TO_SINNOH(PINSIR),
    SPECIES_TO_SINNOH(TAUROS),
    SPECIES_TO_SINNOH(MAGIKARP),
    SPECIES_TO_SINNOH(GYARADOS),
    SPECIES_TO_SINNOH(LAPRAS),
    SPECIES_TO_SINNOH(DITTO),
    SPECIES_TO_SINNOH(EEVEE),
    SPECIES_TO_SINNOH(VAPOREON),
    SPECIES_TO_SINNOH(JOLTEON),
    SPECIES_TO_SINNOH(FLAREON),
    SPECIES_TO_SINNOH(PORYGON),
    SPECIES_TO_SINNOH(OMANYTE),
    SPECIES_TO_SINNOH(OMASTAR),
    SPECIES_TO_SINNOH(KABUTO),
    SPECIES_TO_SINNOH(KABUTOPS),
    SPECIES_TO_SINNOH(AERODACTYL),
    SPECIES_TO_SINNOH(SNORLAX),
    SPECIES_TO_SINNOH(ARTICUNO),
    SPECIES_TO_SINNOH(ZAPDOS),
    SPECIES_TO_SINNOH(MOLTRES),
    SPECIES_TO_SINNOH(DRATINI),
    SPECIES_TO_SINNOH(DRAGONAIR),
    SPECIES_TO_SINNOH(DRAGONITE),
    SPECIES_TO_SINNOH(MEWTWO),
    SPECIES_TO_SINNOH(MEW),
    SPECIES_TO_SINNOH(CHIKORITA),
    SPECIES_TO_SINNOH(BAYLEEF),
    SPECIES_TO_SINNOH(MEGANIUM),
    SPECIES_TO_SINNOH(CYNDAQUIL),
    SPECIES_TO_SINNOH(QUILAVA),
    SPECIES_TO_SINNOH(TYPHLOSION),
    SPECIES_TO_SINNOH(TOTODILE),
    SPECIES_TO_SINNOH(CROCONAW),
    SPECIES_TO_SINNOH(FERALIGATR),
    SPECIES_TO_SINNOH(SENTRET),
    SPECIES_TO_SINNOH(FURRET),
    SPECIES_TO_SINNOH(HOOTHOOT),
    SPECIES_TO_SINNOH(NOCTOWL),
    SPECIES_TO_SINNOH(LEDYBA),
    SPECIES_TO_SINNOH(LEDIAN),
    SPECIES_TO_SINNOH(SPINARAK),
    SPECIES_TO_SINNOH(ARIADOS),
    SPECIES_TO_SINNOH(CROBAT),
    SPECIES_TO_SINNOH(CHINCHOU),
    SPECIES_TO_SINNOH(LANTURN),
    SPECIES_TO_SINNOH(PICHU),
    SPECIES_TO_SINNOH(CLEFFA),
    SPECIES_TO_SINNOH(IGGLYBUFF),
    SPECIES_TO_SINNOH(TOGEPI),
    SPECIES_TO_SINNOH(TOGETIC),
    SPECIES_TO_SINNOH(NATU),
    SPECIES_TO_SINNOH(XATU),
    SPECIES_TO_SINNOH(MAREEP),
    SPECIES_TO_SINNOH(FLAAFFY),
    SPECIES_TO_SINNOH(AMPHAROS),
    SPECIES_TO_SINNOH(BELLOSSOM),
    SPECIES_TO_SINNOH(MARILL),
    SPECIES_TO_SINNOH(AZUMARILL),
    SPECIES_TO_SINNOH(SUDOWOODO),
    SPECIES_TO_SINNOH(POLITOED),
    SPECIES_TO_SINNOH(HOPPIP),
    SPECIES_TO_SINNOH(SKIPLOOM),
    SPECIES_TO_SINNOH(JUMPLUFF),
    SPECIES_TO_SINNOH(AIPOM),
    SPECIES_TO_SINNOH(SUNKERN),
    SPECIES_TO_SINNOH(SUNFLORA),
    SPECIES_TO_SINNOH(YANMA),
    SPECIES_TO_SINNOH(WOOPER),
    SPECIES_TO_SINNOH(QUAGSIRE),
    SPECIES_TO_SINNOH(ESPEON),
    SPECIES_TO_SINNOH(UMBREON),
    SPECIES_TO_SINNOH(MURKROW),
    SPECIES_TO_SINNOH(SLOWKING),
    SPECIES_TO_SINNOH(MISDREAVUS),
    SPECIES_TO_SINNOH(UNOWN),
    SPECIES_TO_SINNOH(WOBBUFFET),
    SPECIES_TO_SINNOH(GIRAFARIG),
    SPECIES_TO_SINNOH(PINECO),
    SPECIES_TO_SINNOH(FORRETRESS),
    SPECIES_TO_SINNOH(DUNSPARCE),
    SPECIES_TO_SINNOH(GLIGAR),
    SPECIES_TO_SINNOH(STEELIX),
    SPECIES_TO_SINNOH(SNUBBULL),
    SPECIES_TO_SINNOH(GRANBULL),
    SPECIES_TO_SINNOH(QWILFISH),
    SPECIES_TO_SINNOH(SCIZOR),
    SPECIES_TO_SINNOH(SHUCKLE),
    SPECIES_TO_SINNOH(HERACROSS),
    SPECIES_TO_SINNOH(SNEASEL),
    SPECIES_TO_SINNOH(TEDDIURSA),
    SPECIES_TO_SINNOH(URSARING),
    SPECIES_TO_SINNOH(SLUGMA),
    SPECIES_TO_SINNOH(MAGCARGO),
    SPECIES_TO_SINNOH(SWINUB),
    SPECIES_TO_SINNOH(PILOSWINE),
    SPECIES_TO_SINNOH(CORSOLA),
    SPECIES_TO_SINNOH(REMORAID),
    SPECIES_TO_SINNOH(OCTILLERY),
    SPECIES_TO_SINNOH(DELIBIRD),
    SPECIES_TO_SINNOH(MANTINE),
    SPECIES_TO_SINNOH(SKARMORY),
    SPECIES_TO_SINNOH(HOUNDOUR),
    SPECIES_TO_SINNOH(HOUNDOOM),
    SPECIES_TO_SINNOH(KINGDRA),
    SPECIES_TO_SINNOH(PHANPY),
    SPECIES_TO_SINNOH(DONPHAN),
    SPECIES_TO_SINNOH(PORYGON2),
    SPECIES_TO_SINNOH(STANTLER),
    SPECIES_TO_SINNOH(SMEARGLE),
    SPECIES_TO_SINNOH(TYROGUE),
    SPECIES_TO_SINNOH(HITMONTOP),
    SPECIES_TO_SINNOH(SMOOCHUM),
    SPECIES_TO_SINNOH(ELEKID),
    SPECIES_TO_SINNOH(MAGBY),
    SPECIES_TO_SINNOH(MILTANK),
    SPECIES_TO_SINNOH(BLISSEY),
    SPECIES_TO_SINNOH(RAIKOU),
    SPECIES_TO_SINNOH(ENTEI),
    SPECIES_TO_SINNOH(SUICUNE),
    SPECIES_TO_SINNOH(LARVITAR),
    SPECIES_TO_SINNOH(PUPITAR),
    SPECIES_TO_SINNOH(TYRANITAR),
    SPECIES_TO_SINNOH(LUGIA),
    SPECIES_TO_SINNOH(HO_OH),
    SPECIES_TO_SINNOH(CELEBI),
    SPECIES_TO_SINNOH(OLD_UNOWN_B),
    SPECIES_TO_SINNOH(OLD_UNOWN_C),
    SPECIES_TO_SINNOH(OLD_UNOWN_D),
    SPECIES_TO_SINNOH(OLD_UNOWN_E),
    SPECIES_TO_SINNOH(OLD_UNOWN_F),
    SPECIES_TO_SINNOH(OLD_UNOWN_G),
    SPECIES_TO_SINNOH(OLD_UNOWN_H),
    SPECIES_TO_SINNOH(OLD_UNOWN_I),
    SPECIES_TO_SINNOH(OLD_UNOWN_J),
    SPECIES_TO_SINNOH(OLD_UNOWN_K),
    SPECIES_TO_SINNOH(OLD_UNOWN_L),
    SPECIES_TO_SINNOH(OLD_UNOWN_M),
    SPECIES_TO_SINNOH(OLD_UNOWN_N),
    SPECIES_TO_SINNOH(OLD_UNOWN_O),
    SPECIES_TO_SINNOH(OLD_UNOWN_P),
    SPECIES_TO_SINNOH(OLD_UNOWN_Q),
    SPECIES_TO_SINNOH(OLD_UNOWN_R),
    SPECIES_TO_SINNOH(OLD_UNOWN_S),
    SPECIES_TO_SINNOH(OLD_UNOWN_T),
    SPECIES_TO_SINNOH(OLD_UNOWN_U),
    SPECIES_TO_SINNOH(OLD_UNOWN_V),
    SPECIES_TO_SINNOH(OLD_UNOWN_W),
    SPECIES_TO_SINNOH(OLD_UNOWN_X),
    SPECIES_TO_SINNOH(OLD_UNOWN_Y),
    SPECIES_TO_SINNOH(OLD_UNOWN_Z),
    SPECIES_TO_SINNOH(TREECKO),
    SPECIES_TO_SINNOH(GROVYLE),
    SPECIES_TO_SINNOH(SCEPTILE),
    SPECIES_TO_SINNOH(TORCHIC),
    SPECIES_TO_SINNOH(COMBUSKEN),
    SPECIES_TO_SINNOH(BLAZIKEN),
    SPECIES_TO_SINNOH(MUDKIP),
    SPECIES_TO_SINNOH(MARSHTOMP),
    SPECIES_TO_SINNOH(SWAMPERT),
    SPECIES_TO_SINNOH(POOCHYENA),
    SPECIES_TO_SINNOH(MIGHTYENA),
    SPECIES_TO_SINNOH(ZIGZAGOON),
    SPECIES_TO_SINNOH(LINOONE),
    SPECIES_TO_SINNOH(WURMPLE),
    SPECIES_TO_SINNOH(SILCOON),
    SPECIES_TO_SINNOH(BEAUTIFLY),
    SPECIES_TO_SINNOH(CASCOON),
    SPECIES_TO_SINNOH(DUSTOX),
    SPECIES_TO_SINNOH(LOTAD),
    SPECIES_TO_SINNOH(LOMBRE),
    SPECIES_TO_SINNOH(LUDICOLO),
    SPECIES_TO_SINNOH(SEEDOT),
    SPECIES_TO_SINNOH(NUZLEAF),
    SPECIES_TO_SINNOH(SHIFTRY),
    SPECIES_TO_SINNOH(NINCADA),
    SPECIES_TO_SINNOH(NINJASK),
    SPECIES_TO_SINNOH(SHEDINJA),
    SPECIES_TO_SINNOH(TAILLOW),
    SPECIES_TO_SINNOH(SWELLOW),
    SPECIES_TO_SINNOH(SHROOMISH),
    SPECIES_TO_SINNOH(BRELOOM),
    SPECIES_TO_SINNOH(SPINDA),
    SPECIES_TO_SINNOH(WINGULL),
    SPECIES_TO_SINNOH(PELIPPER),
    SPECIES_TO_SINNOH(SURSKIT),
    SPECIES_TO_SINNOH(MASQUERAIN),
    SPECIES_TO_SINNOH(WAILMER),
    SPECIES_TO_SINNOH(WAILORD),
    SPECIES_TO_SINNOH(SKITTY),
    SPECIES_TO_SINNOH(DELCATTY),
    SPECIES_TO_SINNOH(KECLEON),
    SPECIES_TO_SINNOH(BALTOY),
    SPECIES_TO_SINNOH(CLAYDOL),
    SPECIES_TO_SINNOH(NOSEPASS),
    SPECIES_TO_SINNOH(TORKOAL),
    SPECIES_TO_SINNOH(SABLEYE),
    SPECIES_TO_SINNOH(BARBOACH),
    SPECIES_TO_SINNOH(WHISCASH),
    SPECIES_TO_SINNOH(LUVDISC),
    SPECIES_TO_SINNOH(CORPHISH),
    SPECIES_TO_SINNOH(CRAWDAUNT),
    SPECIES_TO_SINNOH(FEEBAS),
    SPECIES_TO_SINNOH(MILOTIC),
    SPECIES_TO_SINNOH(CARVANHA),
    SPECIES_TO_SINNOH(SHARPEDO),
    SPECIES_TO_SINNOH(TRAPINCH),
    SPECIES_TO_SINNOH(VIBRAVA),
    SPECIES_TO_SINNOH(FLYGON),
    SPECIES_TO_SINNOH(MAKUHITA),
    SPECIES_TO_SINNOH(HARIYAMA),
    SPECIES_TO_SINNOH(ELECTRIKE),
    SPECIES_TO_SINNOH(MANECTRIC),
    SPECIES_TO_SINNOH(NUMEL),
    SPECIES_TO_SINNOH(CAMERUPT),
    SPECIES_TO_SINNOH(SPHEAL),
    SPECIES_TO_SINNOH(SEALEO),
    SPECIES_TO_SINNOH(WALREIN),
    SPECIES_TO_SINNOH(CACNEA),
    SPECIES_TO_SINNOH(CACTURNE),
    SPECIES_TO_SINNOH(SNORUNT),
    SPECIES_TO_SINNOH(GLALIE),
    SPECIES_TO_SINNOH(LUNATONE),
    SPECIES_TO_SINNOH(SOLROCK),
    SPECIES_TO_SINNOH(AZURILL),
    SPECIES_TO_SINNOH(SPOINK),
    SPECIES_TO_SINNOH(GRUMPIG),
    SPECIES_TO_SINNOH(PLUSLE),
    SPECIES_TO_SINNOH(MINUN),
    SPECIES_TO_SINNOH(MAWILE),
    SPECIES_TO_SINNOH(MEDITITE),
    SPECIES_TO_SINNOH(MEDICHAM),
    SPECIES_TO_SINNOH(SWABLU),
    SPECIES_TO_SINNOH(ALTARIA),
    SPECIES_TO_SINNOH(WYNAUT),
    SPECIES_TO_SINNOH(DUSKULL),
    SPECIES_TO_SINNOH(DUSCLOPS),
    SPECIES_TO_SINNOH(ROSELIA),
    SPECIES_TO_SINNOH(SLAKOTH),
    SPECIES_TO_SINNOH(VIGOROTH),
    SPECIES_TO_SINNOH(SLAKING),
    SPECIES_TO_SINNOH(GULPIN),
    SPECIES_TO_SINNOH(SWALOT),
    SPECIES_TO_SINNOH(TROPIUS),
    SPECIES_TO_SINNOH(WHISMUR),
    SPECIES_TO_SINNOH(LOUDRED),
    SPECIES_TO_SINNOH(EXPLOUD),
    SPECIES_TO_SINNOH(CLAMPERL),
    SPECIES_TO_SINNOH(HUNTAIL),
    SPECIES_TO_SINNOH(GOREBYSS),
    SPECIES_TO_SINNOH(ABSOL),
    SPECIES_TO_SINNOH(SHUPPET),
    SPECIES_TO_SINNOH(BANETTE),
    SPECIES_TO_SINNOH(SEVIPER),
    SPECIES_TO_SINNOH(ZANGOOSE),
    SPECIES_TO_SINNOH(RELICANTH),
    SPECIES_TO_SINNOH(ARON),
    SPECIES_TO_SINNOH(LAIRON),
    SPECIES_TO_SINNOH(AGGRON),
    SPECIES_TO_SINNOH(CASTFORM),
    SPECIES_TO_SINNOH(VOLBEAT),
    SPECIES_TO_SINNOH(ILLUMISE),
    SPECIES_TO_SINNOH(LILEEP),
    SPECIES_TO_SINNOH(CRADILY),
    SPECIES_TO_SINNOH(ANORITH),
    SPECIES_TO_SINNOH(ARMALDO),
    SPECIES_TO_SINNOH(RALTS),
    SPECIES_TO_SINNOH(KIRLIA),
    SPECIES_TO_SINNOH(GARDEVOIR),
    SPECIES_TO_SINNOH(BAGON),
    SPECIES_TO_SINNOH(SHELGON),
    SPECIES_TO_SINNOH(SALAMENCE),
    SPECIES_TO_SINNOH(BELDUM),
    SPECIES_TO_SINNOH(METANG),
    SPECIES_TO_SINNOH(METAGROSS),
    SPECIES_TO_SINNOH(REGIROCK),
    SPECIES_TO_SINNOH(REGICE),
    SPECIES_TO_SINNOH(REGISTEEL),
    SPECIES_TO_SINNOH(KYOGRE),
    SPECIES_TO_SINNOH(GROUDON),
    SPECIES_TO_SINNOH(RAYQUAZA),
    SPECIES_TO_SINNOH(LATIAS),
    SPECIES_TO_SINNOH(LATIOS),
    SPECIES_TO_SINNOH(JIRACHI),
    SPECIES_TO_SINNOH(DEOXYS),
    SPECIES_TO_SINNOH(CHIMECHO),
